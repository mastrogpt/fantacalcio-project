<script lang="ts">
	...
	import logoBalunBg from '$lib/assets/logoBalunBg.png';
	...
	const data = [
		{
			title: '<h2> FantaBalùn  &#x1F916  </h2> <h5> Powered by Nuvolaris</h5>   ',
			description:
				'<h5>Er Bot che ne sa un Bot-to !</h5> <p class="sm:text-sm text-base md:text-lg">Chiedi <strong> ciò che vuoi</strong>, come ad un amico al bar. Pareri, confronti tra calciatori. <strong>Allega lo screen </strong> di un messaggio in cui ti si propone uno scambio: BalùnBot ti dirà se conviene. No, <strong>non scola la pasta!</strong> </p>',
			imageUrl: logoBalunBg,
		...
		{
			title: 'Gli AI-rticoli &#x1F4F0',
			description: `Siamo pigri per scriverli noi. Per stare sempre sul pezzo, i nostri <strong> scraper generano articoli sulle ultime news </strong> <br> Ci servono per istruire Balùnbot, che sarà così in grado di consigliarti al meglio!`,
		...
		{
			title: `<h2>FantaBalùn! </h2> <h6> is Powered by Nuvolaris </h6></p>`,
			description: `
